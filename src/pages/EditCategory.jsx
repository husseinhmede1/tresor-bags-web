...
const EditCategory = () => {
    ...
    useEffect(() => {
        getCategoryById(id).then(res => {
            if (res.success) {
                const c = res.data;
                setForm({ title: c.title, discount: c.discount ?? "", note: c.note ?? "" });
            }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setErrors({ submit: err.message || "Failed to update category" });
        } finally {
            setLoading(false);
        }
    };
        ...
        <div style={S.page}>
            <header style={S.header}>
                <div>
                    ...
                    <h1 style={S.headerTitle}>TRÉSOR BAGS — Edit Category</h1>
                </div>
            ...
            <main style={S.main}>
                <div style={S.card}>
                    ...
                    <p style={S.cardSub}>Update category details below.</p>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={S.formGroup}>
                            ...
                            <textarea
                                ...
                                placeholder='e.g., "With every 2 items you win 1"'
                                rows={4}
                        ...
                        <div style={S.btnRow}>
                            ...
                            <button type="button" className="cf-cancel" onClick={() => navigate("/admin/dashboard")} style={S.cancelBtn}>
                                Cancel
                            </button>
                        </div>
                    </form>
